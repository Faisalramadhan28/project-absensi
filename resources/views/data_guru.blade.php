...
<div>
    ...
    <input type="text" class="form-control" name="nama" placeholder="Enter Nama " aria-describedby="namaHelp">
</div>
<div>
    ...
    <input type="text" list="datalistOptions" class="form-control mb-2" name="mapel[]" placeholder="Pilih">
    <div id="modalAddList">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <div>
            ...
            <input type="text" class="form-control" name="nama" id="editNama" aria-describedby="namaHelp">
        </div>
        <div>
            ...
            <input type="text" list="datalistOptions" class="form-control mb-2" name="mapel[]" id="editMapel" placeholder="Pilih">
...
<script>
    ...
    for(var x = 0; x < editbtn.length; x++){
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" list="datalistOptions" class="form-control" name="mapel[]" placeholder="Pilih" value="`+mapel[y]+`">
        </div>
        `;
            }
    ...
    function modalAddTambah(){
        ...
        <div class="input-group mb-2">
            <button class="btn btn-danger" type="button" onclick="hapusMapel(this)">-</button>
            <input type="text" list="datalistOptions" class="form-control" name="mapel[]" placeholder="Pilih">
        </div>
        `;
    }
