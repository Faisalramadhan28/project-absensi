...
<div class="row align-items-center mb-3">
    ...
    <div class="col-6">
        <div class="form-group m-0">
            <input class="form-control" list="datalistRuang" name="ruang" placeholder="Pilih Ruang">
        </div>
    </div>
    <div class="col-6">
        <div class="form-group m-0">
...
<div class="row mb-3">
    ...
    <div class="col-4">
        <div class ="form-group m-0">
            <input class="form-control" list="datalistGuru" name="guru" placeholder="Pilih Guru">
        </div>
    </div>
    <div class="col-4">
        <div class ="form-group m-0">
            <input class="form-control" list="datalistMapel" name="mapel" placeholder="Pilih Mata Pelajaran">
        </div>
    </div>
    <div class="col-4">
        <div class="form-group m-0">
            <input class="form-control" list="datalistKelas" name="kelas" placeholder="Pilih Kelas">
        </div>
    </div>
</div>
