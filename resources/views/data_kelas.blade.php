...
<div>
    ...
    <input type="text" class="form-control" name="kelas" aria-describedby="KelasHelp">
</div>

<div>
    <label class="form-label">Wali Kelas</label>
    <input class="form-control" list="datalistOptions" name="guru" placeholder="Pilih Wali Kelas">
    ...
    <div class="modal-body">
      <form method="POST" action="/edit/data_kelas">
        ...
        <div>
            ...
            <input type="text" class="form-control" id="editKelas" name="kelas" aria-describedby="KelasHelp">
        </div>

        <div>
            <label class="form-label">Wali Kelas</label>
            <input class="form-control" list="datalistOptions" id="editGuru" name="guru" placeholder="Pilih Wali Kelas">
            <datalist id="datalistOptions">
                @foreach ($data['guru'] as $row)
                    <option value="{{$row['nama']}}">
                @endforeach
