    ...
    <div class="modal-body">
      <form method="POST" action="/add/data_users">
        ...
        <div>
            ...
            <input type="text" class="form-control" name="nama" id="exampleInputNama" placeholder="Enter Nama" aria-describedby="NamaHelp">
        </div>

        <div class="form-group">
          <label for="sel1">Level</label>
          <select class="form-select form-control" name="level" id="pilihJurusan" placeholder="Enter Username">
       ...
       <div>
          ...
          <input type="text" class="form-control" name="username" id="exampleInputusername" placeholder="Enter Username" aria-describedby="usernameHelp">
       </div>
...
<div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
      <form method="POST" action="/edit/data_users">
        ...
        <div>
            <label for="exampleInputNama" class="form-label">Nama</label>
            <input type="text" class="form-control" id="editNama" name="editNama" aria-describedby="NamaHelp">
        </div>
       ...
       <div>
          <label for="exampleInputusername" class="form-label">Username</label>
          <input type="text" class="form-control" id="editUsername" name="editUsername" aria-describedby="usernameHelp">
       </div>
